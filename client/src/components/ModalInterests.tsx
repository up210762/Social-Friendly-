...
import { registerInterestService } from '../services/interests';
    ...
    const handleOnSubmit = async (e: FormEvent<HTMLFormElement>) => {
        try {
            ...
            if (selectedInterests.size > 0) {
                const res = await registerInterestService(selectedInterests)
                ...
                toast.error("Selecciona mínimo 1 interés!");
        } catch (error) {}
    }
